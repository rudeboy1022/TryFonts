...
export const Fantasy: FC = () => {
  ...
  const [isFantasyTextToggle, setIsFantasyTextToggle] =
    useState<boolean>(false);

  const [isFantasyBackgroundToggle, setIsFantasyBackgroundToggle] =
    useState<boolean>(false);
  ...
  return (
    <div id="fantasyContainer" css={fantasyContainerStyle}>
      <h2>Fantasy</h2>
      <div
        className="FantasyBackGroundContainer"
        css={fantasyBackGroundContainerStyle}
        ref={divRef}
      >
        <FantasyTexts
          fontSize={inputFontSizeValue}
          fontWeight={inputFontWeightValue}
          toggle={isFantasyTextToggle}
      ...
      <div id="buttonContainer" css={buttonContainer}>
        <button
          type="button"
          onClick={handleFantasyTextToggle}
        ...
        <button
          type="button"
          onClick={handleFantasyBackgroundToggle}
          css={adjustButtonsStyle}
        >
          {isFantasyBackgroundToggle
            ? "カラーピッカーを閉じる"
