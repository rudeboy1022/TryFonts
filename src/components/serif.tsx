...
export const Serif: FC = () => {
  ...
  const [isSerifBackgroundToggle, setIsSerifBackgroundToggle] =
  ...
  return (
    <div id="serifContainer" css={serifContainerStyle}>
      <h2>Serif</h2>
      <div
        className="serifBackGroundContainer"
        css={serifBackGroundContainerStyle}
        ref={divRef}
      >
        <SerifTexts
          fontSize={inputFontSizeValue}
          fontWeight={inputFontWeightValue}
          toggle={isSerifTextToggle}
      ...
      <div id="buttonContainer" css={buttonContainer}>
        ...
        <button
          type="button"
          onClick={handleSerifBackgroundToggle}
          css={adjustButtonsStyle}
        >
          {isSerifBackgroundToggle
            ? "カラーピッカーを閉じる"
