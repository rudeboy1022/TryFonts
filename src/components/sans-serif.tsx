...
export const SansSerif: FC = () => {
  ...
  const [isSansSerifTextToggle, setIsSansSerifTextToggle] =
    useState<boolean>(false);

  const [isSansSerifBackgroundToggle, setIsSansSerifBackgroundToggle] =
    useState<boolean>(false);
  ...
  const handleSansSerifBackgroundToggle = (
  ...
  return (
    <div id="sansSerifContainer" css={sansSerifContainerStyle}>
      <h2>Sans-Serif</h2>
      <div
        className="sansSerifBackGroundContainer"
        css={sansSerifBackGroundContainerStyle}
        ref={divRef}
      >
        <SansSerifTexts
          fontSize={inputFontSizeValue}
          fontWeight={inputFontWeightValue}
          toggle={isSansSerifTextToggle}
      ...
      <div id="buttonContainer" css={buttonContainer}>
        <button
          type="button"
          onClick={(e) => handleSansSerifTextToggle(e)}
          css={adjustButtonsStyle}
        >
          {isSansSerifTextToggle
            ? "カラーピッカーを閉じる"
            : "文字色のカラーピッカー"}
        </button>
        <button
          type="button"
          onClick={(e) => handleSansSerifBackgroundToggle(e)}
          css={adjustButtonsStyle}
        >
          {isSansSerifBackgroundToggle
            ? "カラーピッカーを閉じる"
